...
// 2026-09-07: MKT — Tele không ghi cuộc gọi trong 10' sau khi UPS chia → thu hồi về kho cơ sở (theo spec MKT List).
Schedule::command('leads:recall-mkt-idle-no-call --minutes=10')->everyMinute();
