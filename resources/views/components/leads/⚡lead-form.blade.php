...
new class extends Component
{
    ...
    public function saveAndGoToBooking(): void
    {
        ...
        $this->save();
        // Sau khi save thành công: auto-close từ phase hiện tại lên $prevPhase (nếu có perm) + nhảy tab.
        // 2026-08-11 fix: Tele bấm "Lưu" từ tab phase 2 khi lead vẫn ở phase 1 (Trực Page vừa tạo)
        // → phải chốt tuần tự phase 1 → phase 2, không gọi trực tiếp closePhase(2) sẽ throw
        // "Chỉ chốt được phase hiện tại (đang ở phase 1)".
