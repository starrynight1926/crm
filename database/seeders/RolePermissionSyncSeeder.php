...
class RolePermissionSyncSeeder extends Seeder
{
    public const MATRIX = [
        'Admin' => [
            ...
            'lead.approve_source', 'lead.book_action', 'lead.create', 'lead.delete',
            ...
            'rule.manage', 'service.manage', 'source.up.admin', 'source.up.sale',
            'source.up.tele', 'source.up.trucpage', 'staff.manage', 'user.manage',
        ],
        'DM HCM' => [
            ...
            'rule.manage', 'service.manage', 'source.up.admin', 'source.up.sale',
            'source.up.tele', 'source.up.trucpage', 'user.manage',
        ],
        'Manager' => [
            'lead.approve_source', 'lead.book_action', 'lead.create', 'lead.distribute',
            'lead.distribute_sale', 'lead.distribute_tele', 'lead.distribute_to_sale',
        ...
        'Admin cơ sở' => [
            ...
            'phase.close.booking', 'phase.close.call', 'phase.close.checkin',
            'phase.close.distribute', 'report.view', 'source.up.admin',
        ],
        'CM sale' => [
            ...
            'source.up.admin', 'source.up.sale',
        ],
        'CM Tele' => [
        ...
        'Team Leader' => [
            ...
            'phase.close.new', 'report.view', 'source.up.sale',
        ],
        'Sale' => [
            'lead.book_action', 'lead.consult', 'lead.create', 'lead.update',
            'lead.update_sale', 'lead.view', 'payment.record', 'phase.close.booking',
            'phase.close.call', 'phase.close.new', 'report.view', 'source.up.sale',
        ],
        'Team sale' => [
